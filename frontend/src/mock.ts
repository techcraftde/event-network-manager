...
],updatedAt:new Date().toISOString(),source:'Demo · Backend offline',vlans:[{id:10,name:'Dante'},{id:20,name:'Control'},{id:30,name:'Lighting'},{id:40,name:'Video'}],devices:[]};
