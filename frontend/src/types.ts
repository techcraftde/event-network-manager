...
export type AlarmReport={generatedAt:string;eventMode:boolean;eventModeSince?:string;healthPercent:number;criticalCount:number;warningCount:number;infoCount:number;checksOk:string[];alarms:Alarm[]};
export type EventModeStatus={enabled:boolean;enabledAt?:string};
